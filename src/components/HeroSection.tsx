      ...
      <div className="relative z-10 container mx-auto px-6 py-24 flex flex-col lg:flex-row items-center gap-12 lg:gap-6">
        ...
        <div className="flex-1 max-w-2xl text-center lg:text-left">
          ...
          >
            ...
            <Button
              size="lg"
              className="h-14 px-8 rounded-xl text-base font-semibold bg-primary text-primary-foreground hover:bg-primary/90 glow-sm group whitespace-nowrap border-0"
              ...
              <div className="rounded-2xl overflow-hidden aspect-[4/5] relative bg-background">
                ...
                {isMobile && (
                  <div className="w-full h-full flex items-center justify-center">
                    <div className="w-48 h-48 rounded-full bg-gradient-to-br from-[hsl(43_72%_64%/0.35)] via-[hsl(43_60%_50%/0.2)] to-[hsl(0_0%_8%/0.2)] blur-2xl" />
                  </div>
                )}
              </div>
              {/* Device notch */}
