...
const OurFocusSection = lazy(() => import("@/components/OurFocusSection").then(m => ({ default: m.OurFocusSection })));
...
const PerformanceMarketingSection = lazy(() => import("@/components/PerformanceMarketingSection").then(m => ({ default: m.PerformanceMarketingSection })));
const TestimonialsSection = lazy(() => import("@/components/TestimonialsSection").then(m => ({ default: m.TestimonialsSection })));
const AIStrategySection = lazy(() => import("@/components/AIStrategySection").then(m => ({ default: m.AIStrategySection })));
